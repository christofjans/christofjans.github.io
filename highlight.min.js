...
strings:i,keywords:u}}}})());hljs.registerLanguage("less",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("protobuf",(()=>{"use strict";return e=>({
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(e){
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("http",(()=>{"use strict";function e(...e){
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
